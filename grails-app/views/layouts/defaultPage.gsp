...
<body>
    <div class="page-title">
        <div class="title_left">
            <h3><g:pageProperty name="page.title"></g:pageProperty> <small><g:pageProperty name="page.title-subtext"></g:pageProperty></small></h3>
        </div>

        <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <g:pageProperty name="page.title-right"></g:pageProperty>
                <!--
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><g:pageProperty name="page.panel-title"></g:pageProperty> <small><g:pageProperty name="page.panel-subtitle"></g:pageProperty></small></h2>
                    <!--
